...
ora - Loading spinners
[NEW] 
packages/cli/bin/lingo-guardian.js
Main CLI entry point with lint command.
...
Inject CSS overflow detection script
Apply text transformations (pseudo-locale, RTL)
Detect elements with scrollWidth > offsetWidth
Capture screenshots of problematic elements
Generate JSON/HTML report
[NEW] 
packages/cli/src/transforms/pseudo-locale.js
Pseudo-locale text expander for testing text growth.
...
Adds ~35% character expansion to simulate worst-case translations
[NEW] 
packages/cli/src/transforms/rtl.js
RTL layout transformation for Arabic/Hebrew testing.
...
[NEW] 
.github/workflows/lingo-guardian.yml
GitHub Action workflow triggered on PRs.
...
Start dev server
Run lingo-guardian lint in screenshot mode
Post results as PR comment with comparison table
[NEW] 
.github/actions/lingo-guardian/action.yml
Custom GitHub Action definition.
